                ...
                <div className="container-fluid" style={{ width: '70%' }}>
                    <div className="form-group coulmn mb-3">
                        ...
                        <div className="col-sm-10">
                            <input name='customer' type="text" className="form-control" id="customer" placeholder="Enter Your Name"
                                onChange={(e) => handleform(e)} value={order.customer} />
                        </div>
                    </div>
                    <div className="form-group coulmn mb-3">
                        <label htmlFor="prdName" className="col-sm-2 col-form-label">Product Name :</label>
                        <div className="col-sm-10">
                            <input name='productName' type="text" className="form-control" id="prdName" placeholder="Enter Product Name"
                                onChange={(e) => handleform(e)} value={order.productName} />
                        </div>
                    </div>
                    <div className="form-group coulmn mb-3">
                        <label htmlFor="img" className="col-sm-2 col-form-label">Image :</label>
                        <div className="col-sm-10">
                            <input name='img' type="text" className="form-control" id="img" placeholder="Enter URL of Image"
                                onChange={(e) => handleform(e)} value={order.img} />
                        </div>
                    </div>
                    <div className="form-group coulmn mb-3">
                        <label htmlFor="count" className="col-sm-2 col-form-label">count :</label>
                        <div className="col-sm-10">
                            <input name='count' type="number" className="form-control" id="count" placeholder="Enter count of product"
                                onChange={(e) => handleform(e)} value={order.count} />
                        </div>
                    </div>
                    <div className="form-group coulmn mb-3">
                        <label htmlFor="price" className="col-sm-2 col-form-label">price :</label>
                        <div className="col-sm-10">
                            <input name='price' type="number" className="form-control" id="price" placeholder="Enter Price of product"
                                onChange={(e) => handleform(e)} value={order.price} />
                        </div>
                    </div>
                    <div className="form-group coulmn mb-3">
                        <label htmlFor="name" className="col-sm-2 col-form-label">Paid :</label>
                        <div className="col-sm-10">
                            <input name='paid' type="text" className="form-control" id="name" placeholder="You paid by via. Please Enter Yes or No"
                                onChange={(e) => handleform(e)} value={order.paid} />
                        </div>
                    </div>
                </div>
